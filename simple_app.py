...
def main():
    ...
    with st.sidebar:
        ...
        if input_method == "Company Name":
            ...
            if company_name:
                ...
                symbol = symbol_lookup.get(company_name.lower(), company_name.upper())
        else:
            symbol = st.text_input("Enter stock symbol:", placeholder="e.g., AAPL, TSLA, MSFT").upper()
    ...
    # Information section
        ...
        2. Click "Run Fermi Analysis" to generate results
        3. Review the spider chart and detailed report
